        ...
        <table>
            <c:forEach items="${utilisateur.getComptes()}" var="compte">
                <c:if test="${param.idCompte==compte.getId_compte()}">
                    <a href="/listeComptes"><img src="http://cdn.onlinewebfonts.com/svg/img_225291.png" alt="arrowLeft" height="15px"></a><br>
                    ...
                    <c:forEach items="${compte.getTransactions()}" var="transaction">
                        <tr>
                            ...
                            <td><a href="/detailsTransaction?idTransac=${transaction.getId_transaction()}"><button class="btn btn-info"><fmt:message key = "see_more"/></button></a></td>
                        </tr>
                    </c:forEach>
                </c:if>
            </c:forEach>
